def layers():
  ...
  Informality: {
    ...
    metadata_"url": `https://geoservicios.upra.gov.co/arcgis/services/formalizacion_propiedad/Indice_Informalidad_2014_Dep/MapServer/WMSServer?request=GetCapabilities&service=WMS`,
    "sourcetype": "raster",
    "layertype": "raster",
    "legend": true,
    "legendSettings": [ {
